...
Whether you are just checking to make sure things are on track, or have a specific symptom you are concerned about, choosing your doctor is the first step.</p>
    ...
    <h1 style="color: black">please select your city
    </h1><form method="post" action="selectCity.php">
    <select style="width: 150px" name="select">
        <option value="null">select</option>
        <option value="NOIDA">NOIDA</option></select>
        
    <select style="width: 150px" name="select2">
        <option value="null">select</option>
    <option value="SECTOR-58">SECTOR 58</option>
    <option value="SECTOR-62">SECTOR 62</option>
    <option value="SECTOR-63">SECTOR 63</option>
    <option value="SECTOR-71">SECTOR 71</option></select>
    
    <select style="width: 150px" name="select3">
